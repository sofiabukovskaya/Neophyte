...
class CvTab extends GetView<CvTabController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CvTabController>(
                    ...
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        title: const Text('Add a candidate',
                            style:
                                TextStyle(fontFamily: 'avenir', fontSize: 18)),
                        content: SizedBox(
                          height: 350,
                          width: 400,
                        ...
                        actions: [
                          ...
                          TextButton(
                            onPressed: () {
                              final vacancy = controller.vacanciesList[
                                  controller.vacanciesList.indexWhere(
                                (element) =>
                                    element.name == controller.firstValue.value,
                              )];
